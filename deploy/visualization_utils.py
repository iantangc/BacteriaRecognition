...
#
# WARNING: This file is modified from the orginal version for use
#
...
STANDARD_COLORS = [
    'Red', 'Chartreuse', 'Magenta', 'Aquamarine', 'Azure', 'Beige', 'Bisque',
    ...
    'LimeGreen', 'Linen', 'Aqua', 'MediumAquaMarine', 'MediumOrchid',
...
def draw_bounding_box_on_image_array(image,
  ...
  draw_bounding_box_on_image(image_pil, ymin, xmin, ymax, xmax, color,
                             ...
                             use_normalized_coordinates, fontsize, alpha)
